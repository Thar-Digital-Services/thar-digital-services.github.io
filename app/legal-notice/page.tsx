    ...
    <>
      ...
      <div className="absolute inset-0">
        <Image
          ...
          alt="Legal notice page background"
          fill
        ...
        >
          <motion.div variants={itemVariants}>
            <p className="text-muted-foreground leading-relaxed">
              Thar Digital Services is a technology services corporation headquartered in Bikaner, Rajasthan, India. We specialise in providing enterprise-level engineering teams and software development services for startups and scale-ups. We help businesses build, scale, and operate reliable software products with dedicated engineering expertise.
            </p>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="space-y-4 pt-6 border-t border-border/30">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3 pt-4 border-t border-border/20">
                <h3 className="text-lg font-semibold text-foreground">Principal Place of Business</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <div>
              ...
              {/* Proprietor Details */}
              <div className="space-y-3 pt-4 border-t border-border/20">
                <h3 className="text-lg font-semibold text-foreground">Proprietor Details</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <div>
